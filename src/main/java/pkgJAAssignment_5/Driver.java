...
public class Driver {
    ...
    public static void main(String[] args) {
        JAWindowManager myWM = JAWindowManager.get(WIN_WIDTH, WIN_HEIGHT, WIN_POS_X, WIN_POX_Y);
        myWM = JAWindowManager.get();
        myWM = JAWindowManager.get(2*WIN_WIDTH, 2*WIN_HEIGHT, WIN_POS_X, WIN_POX_Y);
        new Driver().render(myWM);
    } // public static void main(String[] args)

    void render(JAWindowManager myWindowManager) {
        myWindowManager.updateContextToThis();
        renderLoop(myWindowManager);
        myWindowManager.destroyGlfwWindow();
    } // void render()

    void renderLoop(JAWindowManager myWindowManager) {
        glfwPollEvents();
        initOpenGL();
    ...
    void renderObjects(JAWindowManager myWM) {
